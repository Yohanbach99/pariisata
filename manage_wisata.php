...
<head>
  ...
  <title>WONDERFUL INDOENSIA</title>
...
<body>
    ...
    <nav>
      <ul>
          <li><form action="pencarian.php" method="get">
            ...
            <li><a href="#INFORMATIKA">Manage Wisata</a></li>
  ...
  <div class="container">
    <div class="intro">
      <p class="title">Hallo Administrator <?php echo $_SESSION['username']; ?>, Bagaimana Pola Tidurmu Akhir-Akhir Ini?</p>
    </div>
  </div>

  
    <div class="parallaxmanage">
      <div class="tentang">
        <p class="title">ANDA BERADA DI HALAMAN MANAGE WISATA YANG ANDA KELOLA</p>
        <p class="description">Hai Administrator, Berikut adalah semua data yang telah kamu input dalam system</p>
        <div class="mt-10">
        </div>
      </div>
...
<button class="btn-cta"><a href="add_wisata.php">Tambah Objek Wisata</a></button>
	<br><br>
	<button class="btn-cta"><a href="dashboard.php">Kembali ke Dashboard</a></button>
...
<footer>
  ...
  function openModal(id_wisata) {
    ...
    xmlhttp.open("GET", "viewmng.php?id=" + id_wisata, true);
    xmlhttp.send();
  }
